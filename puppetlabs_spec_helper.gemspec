...
# -*- encoding: utf-8 -*-
# stub: puppetlabs_spec_helper 1.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
    ...
    if RUBY_VERSION =~ /^1\./
      s.add_runtime_dependency(%q<rubocop>, ["0.41.2"])
    else
      s.add_runtime_dependency(%q<rubocop>, [">= 0"])
      s.add_runtime_dependency(%q<rubocop-rspec>, ["~> 1.6"]) if RUBY_VERSION >= '2.3.0'
    end
  else
    ...
    s.add_dependency(%q<puppet>, [ENV['PUPPET_VERSION'] || "~> 3.8.3"])
    if RUBY_VERSION =~ /^1\./
      s.add_dependency(%q<rubocop>, ["0.41.2"])
    else
      s.add_dependency(%q<rubocop>, [">= 0"])
      s.add_dependency(%q<rubocop-rspec>, ["~> 1.6"]) if RUBY_VERSION >= '2.3.0'
    end
  end
end
