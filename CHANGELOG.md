...
Fix gemspec dependencies that were incorrectly generated by Jeweler when
building the gem causing 1.2.0 to only function on ruby 2.2.0 and higher.

### Fixed:
- Gemspec is now manually managed again, jeweler is removed

## [1.2.0] - 2016-08-23 - YANKED
### Summary:
